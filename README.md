# How do different training datasets using various PQ models affect the accuracy of a learning-based AC optimal power flow in a local electricity market?
